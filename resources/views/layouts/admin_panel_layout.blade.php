...
<div id="page-container">
    <div class="container-fluid"> <!-- Add px-0 to remove horizontal padding -->
        <div class="row"> <!-- Add mx-0 to remove horizontal margins -->
{{--            <div class="col-1 bg-light p-0"> <!-- Add p-0 to remove padding -->--}}

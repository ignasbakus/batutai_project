...
<html>
<head>
    <title>Paredaguotas užsakymas</title>
    <style>
        body {
...
<div class="container">
    <div class="header">
        <h1>Užsakymas atnaujintas</h1>
    </div>

    <!-- Update Notification -->
    <p>Užsakymas Nr. <strong>{{ $order->order_number }}</strong> buvo atnaujintas.</p>
    ...
    <div class="price-info">
        ...
        <table>
            ...
            <tr>
                ...
                <td>{{ number_format($order->total_sum - $order->advance_sum, 2) }}{{ config('trampolines.currency') }}</td>
            </tr>
            </tbody>
        </table>
    </div>
